...
<strong>Warning:</strong> Sora 2 might be unavailable for new deployments in some regions. Before starting this lab, check whether you can deploy the model in Microsoft Foundry with your subscription and selected region. If it is unavailable, you might not be able to complete the lab as written.
</div>
