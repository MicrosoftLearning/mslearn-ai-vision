...
1. In Visual Studio Code, in the **Explorer** pane, browse to the **Labfiles/04-face** folder and expand the **C-Sharp** or **Python** folder depending on your language preference.
